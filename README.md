...
LLM-C wraps HTTP communication, JSON parsing, and provider-specific LLM protocols into a single portable C99 library. Target use cases include embedded systems, game engines, high-performance computing, and native desktop applications.

**Status:** v0.1.0 - Core SDK with Ollama provider implemented.
...
| -------------- | -------------- | --------------- | ------------ |
| **Ollama**     | REST API       | `gpt-oss:120b`  | Bearer token |
